...
import { z } from 'zod';
import { adminTypes } from '../data/data';
...
export function AdminsInviteDialog({ open, onOpenChange }: Props) {
            ...
            <DialogContent className="sm:max-w-md">
                <DialogHeader className="text-left">
                    <DialogTitle className="flex items-center gap-2">
                        <IconMailPlus /> Invite Admin
                    </DialogTitle>
                    <DialogDescription>
                        Invite new admin to join your team by sending them an
